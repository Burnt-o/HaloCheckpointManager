...
namespace HCM3.Services
{
    public class DetourInfoObject
    {
        ...
        public Dictionary<string, object> SymbolPointers { get; init; }


        public DetourInfoObject(ReadWrite.Pointer originalCodeLocation, byte[] originalCodeBytes, int sizeToAlloc, string detourCodeASM, string hookCodeASM, Dictionary<string, object> symbolPointers)
        { 

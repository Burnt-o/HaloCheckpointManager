...
{ 
    public partial class HaloMemoryService
    {
        ...
        { 
                ...
                this.ReadWrite.WriteBytes(detourInfo.OriginalCodeLocation, detourInfo.OriginalCodeBytes, true);
            ...
            if (detourHandle != null)
            {
                ...
                try
                {
                    Process MCCProcess = Process.GetProcessById((int)this.HaloMemoryManager.ProcessID);

...
{
    internal class InjectViewModel : Presenter, IControlWithHotkey
    {
        ...
        public InjectViewModel(string hotkeyText, string effectText, CheckpointViewModel? checkpointViewModel) 
        {
            ...
            {
                this.ExecuteCommand = checkpointViewModel.Inject;
            }

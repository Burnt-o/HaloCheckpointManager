...
namespace HCM3.ViewModels
{
    public class SpeedhackViewModel : ActionToggleBase
    {
        ...
        public Speedhack PC_Speedhack { get; init; }
        ...
        public SpeedhackViewModel(string effectText, Speedhack? pC_Speedhack, HotkeyManager? hotkeyManager)
        {
            this.PC_Speedhack = pC_Speedhack; //for binding to IsChecked
            this.EffectText = effectText;
            this.ExecuteCommand = new RelayCommand(o => pC_Speedhack.DoCheat(), o => true);
            this.ApplyCommand = new RelayCommand(o => pC_Speedhack.DoCheat(), o => true);

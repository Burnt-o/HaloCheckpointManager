...
namespace HCM3.ViewModels
{
    public class TeleportViewModel : ActionToggleBase
    {
        ...
        CheatManagerService CheatManagerService { get; init; }
        ...
        public TeleportViewModel(string effectText, CheatManagerService? cheatManagerService, HotkeyManager? hotkeyManager)
        {
        ...
        private void FillPosition()
        {
            //try
            //{
            //    ForceTeleport forceTeleport = this.CheatManagerService.ListOfCheats["ForceTeleport"] as ForceTeleport;
            //    (float, float, float) tuple = forceTeleport.TeleportGetPosition();

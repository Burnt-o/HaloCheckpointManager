...
namespace HCM3.ViewModels
{
    public class DisplayInfoViewModel : ActionToggleBase
    {
        ...
        IPersistentCheat DisplayInfo { get; init; }
        ...
        public DisplayInfoViewModel(string effectText, IPersistentCheat displayInfo, HotkeyManager? hotkeyManager) 
        {

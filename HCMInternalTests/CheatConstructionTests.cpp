...
#define MAKE_CHEATTESTPAIR_SET(r, d, seq) BOOST_PP_SEQ_FOR_EACH_I(MAKE_CHEATTEST_PAIR, BOOST_PP_SEQ_HEAD(seq), BOOST_PP_SEQ_TAIL(seq))

#define TEST_ALL_CHEATPAIRS(seq) BOOST_PP_SEQ_FOR_EACH(MAKE_CHEATTESTPAIR_SET, _, seq)



#define TEST_MCC_VERSION(MCC_VERSION) 	\
...
{ \
	...
	TEST_ALL_CHEATPAIRS(TOP_GUI_ELEMENTS)\
